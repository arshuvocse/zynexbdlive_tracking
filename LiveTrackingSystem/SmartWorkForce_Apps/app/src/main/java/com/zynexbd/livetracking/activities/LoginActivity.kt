        ...
        viewModel.uiState.observe(this) { state ->
            when (state) {
                ...
                is LoginUiState.Error -> {
                    ...
                    if (state.message.contains("ডিভাইস", ignoreCase = true) || state.message.contains("Device", ignoreCase = true)) {
                        androidx.appcompat.app.AlertDialog.Builder(this)
                            .setTitle(if (isEn) "Device Restriction" else "ডিভাইস সুরক্ষা সতর্কতা")
                            .setMessage(msg)
